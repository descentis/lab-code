...
def create_vectorstore(documents):
    ...
    print("vectorstore has been created")
    return vectorstore
...
st.set_page_config(
    page_title='Prompting',
    layout='centered'
)

st.title("About Animal")

# chat history
if 'chat_history' not in st.session_state:
    st.session_state.chat_history = []

uploaded_file = st.file_uploader(label="Upload file here", type=["pdf"])
if uploaded_file:
    ...
    if "vectorstore" not in st.session_state:
        st.session_state.vectorstore = create_vectorstore(load_document())
...
user_input = st.chat_input("Start conversation...")
